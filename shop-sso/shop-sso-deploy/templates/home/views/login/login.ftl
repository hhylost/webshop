...
<head>
    ...
    <title>登录商城</title>
    <link type="text/css" rel="stylesheet" href="${imageServer}/css/login.css"/>
    <script type="text/javascript" src="${imageServer}/js/jquery-1.6.4.js"></script>
</head>
<body>
<div class="w">
    <div id="logo">
...
<script type="text/javascript">
    ...
    function chageCode(){
        $('#codeImage').attr('src','/user/login/captcha?date='+ (new Date()).valueOf());//链接后添加Math.random，确保每次产生新的验证码，避免缓存问题。
    }
</script>
</body>
</html>